...
//$irudia = $_POST['f_irudia']


$sql = "INSERT INTO questions (eposta, testua, erantzun_zuzena, erantzun_okerra_1, erantzun_okerra_2, erantzun_okerra_3, galderaren_zailtasuna, gai_arloa) 
VALUES ('$eposta', '$testua', '$erantzunZuzena', '$erantzun_okerra_1', '$erantzun_okerra_2', '$erantzun_okerra_3', '$zailtasuna', '$gai_arloa')";

if ($connection->query($sql) === TRUE) {
    echo  'Galdera gorde da!\n';
	echo  '<a href = "../addQuestion.html" >Beste galdera bat sartu.</a>\n';
	echo  '<a href = "showQuestions.php" >Ikusi ze galdera dauden.</a>\n';

...
Erantzun Okerra 1 </th><th> Erantzun Okerra 2 </th><th> Erantzun Okerra 3 </th><th> Zailtasuna </th><th> Gai arloa </th></tr>';
...
if ($emaitza->num_rows > 0) {
	while ($row = $emaitza->fetch_assoc()) {
		...
		<td>'.$row['erantzun_okerra_3'].'</td><td>'.$row['galderaren_zailtasuna'].'</td><td>'.$row['gai_arloa'].'</td></tr>';
	}
} else {
	echo "Errorea";	
}
